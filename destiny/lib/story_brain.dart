...
class StoryBrain {
  ...
  //method hat returns the first storyTitle from _storyData.
  String getStory() {
    return _storyData[_storyNumber].storyTitle;
  }

  //method that returns the text for the first choice1 from _storyData.
  String getChoice1() {
    return _storyData[_storyNumber].choice1;
  }

  //method that returns the text for the first choice2 from _storyData.
  String getChoice2() {
